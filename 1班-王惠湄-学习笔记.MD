...
|方法|函数名|示例|说明|
|---|---|---|---|
|添加元素|.append(value)|list.append(value)|无|
|插入元素|.insert(index,value)|list.insert(0,value)|无|
|删除元素|del list[index]|del list[0]|无|
|删除元素并使用该元素|.pop(index)|newValue = list.pop(0)|删除的值可赋值到新元素|
